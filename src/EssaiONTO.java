...
public class EssaiONTO {
	
	private EssaiONTO() {}
	
	static String index = "/media/jeyasoth1u/86562BD7562BC731/GMD/Index/ATC_Index1";
	static File f = new File(index);
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    //String index = "OmimOnto_Index1";
	    String field = "codeATC";
	    String queries = null ;
	    ...
	    while (true) {
	      ...
	      //Query query = parser.parse(queryString, "contentKeywords", analyzer);
	  ...
	  public static void doPagingSearch(BufferedReader in, IndexSearcher searcher, Query query, 
	    ...
	    while (true) {
	      ...
	      for (int i = start; i < end; i++) {
	        ...
	        String path = doc.get("codeATC");
	        //System.out.println(doc.get("classID"));
	        if (path != null) {
	        	System.out.println("codeATC : "+ path +" name :"+doc.get("name"));
	        } else {
	          //System.out.println((i+1) + ". " + "No label for this unknown ATC_id");
	        }
